...
function renderCalendar() {
    ...
    eventBox.style.display = 'none'; // Nascondo il box all'avvio del calendario
...
function showEvent(eventDate) {
    ...
    eventBox.style.display = 'block';  // Mostro il riquadro ogni volta che si clicca un giorno
}
...
// Pulsante per espandere il riquadro (se presente)
